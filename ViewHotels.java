...
public class ViewHotels extends JFrame implements Runnable{
    ...
    public void run(){
        String[] text = new String[]{"InterContinental Dhaka","Pan Pacific","Radisson Blu Chattogram","Le Meridien","The Westin Dhaka","Sea Pearl Beach Resort & Spa","Amari Dhaka","Holidau Inn Dhaka","The Palace Luxary Hotel - Sylhet","DuSai Resort & Spa"};
        try{
            for(int i =0; i <=9; i++){
    ...
    ViewHotels(){
        setBounds(290,100,800,600);
        
        Caption = new JLabel();
        Caption.setBounds(50,110,1000,70);

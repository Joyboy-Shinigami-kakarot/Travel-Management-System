...
public class BookHotel extends JFrame implements ActionListener {
    ...
    if (ae.getSource() == checkprice) {
        ...
        try {
            ...
            // Insert into hotelbooked
            String query1 = "INSERT INTO hotelbooked VALUES('" + labelusername.getText() + "', '" +
                            chotel.getSelectedItem() + "', '" + tfpersons.getText() + "', '" + 
                            tfdays.getText() + "', '" + labelid.getText() + "', '" + 
                            labelnumber.getText() + "', '" + labelphone.getText() + "', '" + 
                            labelprice.getText() + "')";
            c.s.executeUpdate(query1);

            // Insert into food_ac
            String query2 = "INSERT INTO food_ac VALUES('" + labelusername.getText() + "', '" +
                            cac.getSelectedItem() + "', '" + cfood.getSelectedItem() + "')";
